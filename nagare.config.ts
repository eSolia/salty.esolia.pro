...
`,
  ...
  // Tell Nagare about all files that contain version references
  updateFiles: [
    {
      path: "./deno.json",
      patterns: {
    ...
    },
    {
      ...
      patterns: {
        ...
        // Update build date badge if present
        buildBadge:
          /\[!\[Build Date\]\(https:\/\/img\.shields\.io\/badge\/build-([^-]+)-green\.svg\)\]/,
      },
      updateFn: (content: string, data: any) => {
        ...
        // Update build date badge
        const buildDate = new Date().toISOString().split("T")[0];
        content = content.replace(
          /\[!\[Build Date\]\(https:\/\/img\.shields\.io\/badge\/build-([^-]+)-green\.svg\)\]/,
          `[![Build Date](https://img.shields.io/badge/build-${buildDate}-green.svg)]`,
        );
